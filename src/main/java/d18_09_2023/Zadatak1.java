...
public class Zadatak1 {
    ...
    public static void main(String[] args) {
        VideoPlayer videoPlayerA = new VideoPlayer(600, 50, 30, 144);
        videoPlayerA.stampaj();
        System.out.println("****");
        TimeControl kontrolavremena = new TimeControl();
        kontrolavremena.setNapred(false);
        kontrolavremena.izvrsiAkciju(videoPlayerA);
        videoPlayerA.stampaj();
        System.out.println("****");
        AudioControl audio = new AudioControl();
        audio.setSmanjeno(true);
        audio.izvrsiAkciju(videoPlayerA);
        videoPlayerA.stampaj();
        System.out.println("****");
        QualityOptimizerControl kvalitet = new QualityOptimizerControl();
        kvalitet.setBrzinaNeta(48);
        kvalitet.izvrsiAkciju(videoPlayerA);
        videoPlayerA.stampaj();
